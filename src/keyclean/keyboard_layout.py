...
_ROW0: List[KeyDef] = [
    ...
    KeyDef("prtsc",  "PrtSc",    _NAV_OFFSET + 0.0, 0, 1.0, 1.0, pygame.K_PRINTSCREEN),
    KeyDef("scrlk",  "ScrLk",    _NAV_OFFSET + 1.0, 0, 1.0, 1.0, pygame.K_SCROLLLOCK),
...
# ---------------------------------------------------------------------------
_ROW3: List[KeyDef] = [
    KeyDef("caps",   "Caps Lock", +0.00, 3.5, 1.75, 1.0, pygame.K_CAPSLOCK),
    KeyDef("a",      "A",         +1.75, 3.5, 1.00, 1.0, pygame.K_a),
    KeyDef("s",      "S",         +2.75, 3.5, 1.00, 1.0, pygame.K_s),
    KeyDef("d",      "D",         +3.75, 3.5, 1.00, 1.0, pygame.K_d),
    KeyDef("f",      "F",         +4.75, 3.5, 1.00, 1.0, pygame.K_f),
    KeyDef("g",      "G",         +5.75, 3.5, 1.00, 1.0, pygame.K_g),
    KeyDef("h",      "H",         +6.75, 3.5, 1.00, 1.0, pygame.K_h),
    KeyDef("j",      "J",         +7.75, 3.5, 1.00, 1.0, pygame.K_j),
    KeyDef("k",      "K",         +8.75, 3.5, 1.00, 1.0, pygame.K_k),
    KeyDef("l",      "L",         +9.75, 3.5, 1.00, 1.0, pygame.K_l),
    KeyDef("semi",   ";\n:",      10.75, 3.5, 1.00, 1.0, pygame.K_SEMICOLON),
    KeyDef("quote",  "'\n\"",     11.75, 3.5, 1.00, 1.0, pygame.K_QUOTE),
...
# ---------------------------------------------------------------------------
_ROW4: List[KeyDef] = [
    KeyDef("lshift", "Shift",    +0.00, 4.5, 2.25, 1.0, pygame.K_LSHIFT),
    KeyDef("z",      "Z",        +2.25, 4.5, 1.00, 1.0, pygame.K_z),
    KeyDef("x",      "X",        +3.25, 4.5, 1.00, 1.0, pygame.K_x),
    KeyDef("c",      "C",        +4.25, 4.5, 1.00, 1.0, pygame.K_c),
    KeyDef("v",      "V",        +5.25, 4.5, 1.00, 1.0, pygame.K_v),
    KeyDef("b",      "B",        +6.25, 4.5, 1.00, 1.0, pygame.K_b),
    KeyDef("n",      "N",        +7.25, 4.5, 1.00, 1.0, pygame.K_n),
    KeyDef("m",      "M",        +8.25, 4.5, 1.00, 1.0, pygame.K_m),
    KeyDef("comma",  ",\n<",     +9.25, 4.5, 1.00, 1.0, pygame.K_COMMA),
    KeyDef("period", ".\n>",     10.25, 4.5, 1.00, 1.0, pygame.K_PERIOD),
    KeyDef("slash",  "/\n?",     11.25, 4.5, 1.00, 1.0, pygame.K_SLASH),
...
# ---------------------------------------------------------------------------
_ROW5: List[KeyDef] = [
    KeyDef("lctrl",  "Ctrl",     +0.00, 5.5, 1.25, 1.0, pygame.K_LCTRL),
    KeyDef("lmeta",  "Meta",     +1.25, 5.5, 1.25, 1.0, pygame.K_LMETA),
    KeyDef("lalt",   "Alt",      +2.50, 5.5, 1.25, 1.0, pygame.K_LALT),
    KeyDef("space",  "",         +3.75, 5.5, 6.25, 1.0, pygame.K_SPACE),
    KeyDef("ralt",   "Alt",      10.00, 5.5, 1.25, 1.0, pygame.K_RALT),
    KeyDef("rmeta",  "Meta",     11.25, 5.5, 1.25, 1.0, pygame.K_RMETA),
    KeyDef("menu",   "Menu",     12.50, 5.5, 1.25, 1.0, pygame.K_MENU),
...
_NAV: List[KeyDef] = [
    ...
    KeyDef("pgup",   "PgUp",     _NAV_OFFSET + 2.0, 1.5, 1.0, 1.0, pygame.K_PAGEUP),
    # Row 2.5
    KeyDef("delete", "Del",      _NAV_OFFSET + 0.0, 2.5, 1.0, 1.0, pygame.K_DELETE),
    KeyDef("end",    "End",      _NAV_OFFSET + 1.0, 2.5, 1.0, 1.0, pygame.K_END),
    KeyDef("pgdn",   "PgDn",     _NAV_OFFSET + 2.0, 2.5, 1.0, 1.0, pygame.K_PAGEDOWN),
    # Arrow keys — Up alone at row 4.5, Left/Down/Right at row 5.5
    KeyDef("up",     "△\nUp",    _NAV_OFFSET + 1.0, 4.5, 1.0, 1.0, pygame.K_UP),
    KeyDef("left",   "Left\n◁",  _NAV_OFFSET + 0.0, 5.5, 1.0, 1.0, pygame.K_LEFT),
    KeyDef("down",   "Down\n▽",  _NAV_OFFSET + 1.0, 5.5, 1.0, 1.0, pygame.K_DOWN),
    KeyDef("right",  "Right\n▷", _NAV_OFFSET + 2.0, 5.5, 1.0, 1.0, pygame.K_RIGHT),
]
...
_NUMPAD: List[KeyDef] = [
    # Row 1.5
    KeyDef("np_lock",  "Num\nLock", _NP_OFFSET + 0.0, 1.5, 1.0, 1.0, pygame.K_NUMLOCKCLEAR),
