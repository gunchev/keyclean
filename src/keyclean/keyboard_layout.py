...
# ---------------------------------------------------------------------------
_ROW1: List[KeyDef] = [
    KeyDef("grave",  "`\n~",     0.0,  1, 1.0, 1.0, pygame.K_BACKQUOTE),
    KeyDef("1",      "1\n!",     1.0,  1, 1.0, 1.0, pygame.K_1),
    KeyDef("2",      "2\n@",     2.0,  1, 1.0, 1.0, pygame.K_2),
    KeyDef("3",      "3\n#",     3.0,  1, 1.0, 1.0, pygame.K_3),
    KeyDef("4",      "4\n$",     4.0,  1, 1.0, 1.0, pygame.K_4),
    KeyDef("5",      "5\n%",     5.0,  1, 1.0, 1.0, pygame.K_5),
    KeyDef("6",      "6\n^",     6.0,  1, 1.0, 1.0, pygame.K_6),
    KeyDef("7",      "7\n&",     7.0,  1, 1.0, 1.0, pygame.K_7),
    KeyDef("8",      "8\n*",     8.0,  1, 1.0, 1.0, pygame.K_8),
    KeyDef("9",      "9\n(",     9.0,  1, 1.0, 1.0, pygame.K_9),
    KeyDef("0",      "0\n)",     10.0, 1, 1.0, 1.0, pygame.K_0),
    KeyDef("minus",  "-\n_",     11.0, 1, 1.0, 1.0, pygame.K_MINUS),
    KeyDef("equals", "=\n+",     12.0, 1, 1.0, 1.0, pygame.K_EQUALS),
    KeyDef("bspace", "Backspace", 13.0, 1, 2.0, 1.0, pygame.K_BACKSPACE),
]
...
_ROW2: List[KeyDef] = [
    ...
    KeyDef("q",      "Q",        1.5,  2, 1.0, 1.0, pygame.K_q),
    KeyDef("w",      "W",        2.5,  2, 1.0, 1.0, pygame.K_w),
    KeyDef("e",      "E",        3.5,  2, 1.0, 1.0, pygame.K_e),
    KeyDef("r",      "R",        4.5,  2, 1.0, 1.0, pygame.K_r),
    KeyDef("t",      "T",        5.5,  2, 1.0, 1.0, pygame.K_t),
    KeyDef("y",      "Y",        6.5,  2, 1.0, 1.0, pygame.K_y),
    KeyDef("u",      "U",        7.5,  2, 1.0, 1.0, pygame.K_u),
    KeyDef("i",      "I",        8.5,  2, 1.0, 1.0, pygame.K_i),
    KeyDef("o",      "O",        9.5,  2, 1.0, 1.0, pygame.K_o),
...
_ROW3: List[KeyDef] = [
    ...
    KeyDef("a",      "A",        1.75, 3, 1.0,  1.0, pygame.K_a),
    KeyDef("s",      "S",        2.75, 3, 1.0,  1.0, pygame.K_s),
    KeyDef("d",      "D",        3.75, 3, 1.0,  1.0, pygame.K_d),
    KeyDef("f",      "F",        4.75, 3, 1.0,  1.0, pygame.K_f),
    KeyDef("g",      "G",        5.75, 3, 1.0,  1.0, pygame.K_g),
    KeyDef("h",      "H",        6.75, 3, 1.0,  1.0, pygame.K_h),
    KeyDef("j",      "J",        7.75, 3, 1.0,  1.0, pygame.K_j),
    KeyDef("k",      "K",        8.75, 3, 1.0,  1.0, pygame.K_k),
...
_ROW4: List[KeyDef] = [
    ...
    KeyDef("v",      "V",        5.25, 4, 1.0,  1.0, pygame.K_v),
    KeyDef("b",      "B",        6.25, 4, 1.0,  1.0, pygame.K_b),
    KeyDef("n",      "N",        7.25, 4, 1.0,  1.0, pygame.K_n),
    KeyDef("m",      "M",        8.25, 4, 1.0,  1.0, pygame.K_m),
    KeyDef("comma",  ",\n<",     9.25, 4, 1.0,  1.0, pygame.K_COMMA),
    KeyDef("period", ".\n>",     10.25, 4, 1.0, 1.0, pygame.K_PERIOD),
    KeyDef("slash",  "/\n?",     11.25, 4, 1.0, 1.0, pygame.K_SLASH),
    KeyDef("rshift", "Shift",    12.25, 4, 2.75, 1.0, pygame.K_RSHIFT),
]
...
# ---------------------------------------------------------------------------
_ROW5: List[KeyDef] = [
    KeyDef("lctrl",  "Ctrl",     0.0,  5, 1.25, 1.0, pygame.K_LCTRL),
    KeyDef("lmeta",  "Meta",     1.25, 5, 1.25, 1.0, pygame.K_LMETA),
    KeyDef("lalt",   "Alt",      2.5,  5, 1.25, 1.0, pygame.K_LALT),
    KeyDef("space",  "",         3.75, 5, 6.25, 1.0, pygame.K_SPACE),
    KeyDef("ralt",   "Alt",      10.0, 5, 1.25, 1.0, pygame.K_RALT),
    KeyDef("rmeta",  "Meta",     11.25, 5, 1.25, 1.0, pygame.K_RMETA),
    KeyDef("menu",   "Menu",     12.5, 5, 1.25, 1.0, pygame.K_MENU),
    KeyDef("rctrl",  "Ctrl",     13.75, 5, 1.25, 1.0, pygame.K_RCTRL),
]
...
_NAV: List[KeyDef] = [
    ...
    KeyDef("home",   "Home",    _NAV_OFFSET + 1.0, 1, 1.0, 1.0, pygame.K_HOME),
    KeyDef("pgup",   "Pg\nUp",  _NAV_OFFSET + 2.0, 1, 1.0, 1.0, pygame.K_PAGEUP),
    # Row 2
    KeyDef("delete", "Del",     _NAV_OFFSET + 0.0, 2, 1.0, 1.0, pygame.K_DELETE),
    KeyDef("end",    "End",     _NAV_OFFSET + 1.0, 2, 1.0, 1.0, pygame.K_END),
    KeyDef("pgdn",   "Pg\nDn",  _NAV_OFFSET + 2.0, 2, 1.0, 1.0, pygame.K_PAGEDOWN),
    # Arrow keys — row 4-5 (Up alone at row 4, Left/Down/Right at row 5)
    KeyDef("up",     "↑",       _NAV_OFFSET + 1.0, 4, 1.0, 1.0, pygame.K_UP),
    KeyDef("left",   "←",       _NAV_OFFSET + 0.0, 5, 1.0, 1.0, pygame.K_LEFT),
    KeyDef("down",   "↓",       _NAV_OFFSET + 1.0, 5, 1.0, 1.0, pygame.K_DOWN),
    KeyDef("right",  "→",       _NAV_OFFSET + 2.0, 5, 1.0, 1.0, pygame.K_RIGHT),
]
...
_NUMPAD: List[KeyDef] = [
    # Row 1
    KeyDef("np_lock",  "Num\nLk",  _NP_OFFSET + 0.0, 1, 1.0, 1.0, pygame.K_NUMLOCKCLEAR),
    KeyDef("np_slash", "/",        _NP_OFFSET + 1.0, 1, 1.0, 1.0, pygame.K_KP_DIVIDE),
    KeyDef("np_star",  "*",        _NP_OFFSET + 2.0, 1, 1.0, 1.0, pygame.K_KP_MULTIPLY),
    KeyDef("np_minus", "-",        _NP_OFFSET + 3.0, 1, 1.0, 1.0, pygame.K_KP_MINUS),
    # Row 2
    KeyDef("np_7",     "7",        _NP_OFFSET + 0.0, 2, 1.0, 1.0, pygame.K_KP7),
    KeyDef("np_8",     "8",        _NP_OFFSET + 1.0, 2, 1.0, 1.0, pygame.K_KP8),
    KeyDef("np_9",     "9",        _NP_OFFSET + 2.0, 2, 1.0, 1.0, pygame.K_KP9),
    KeyDef("np_plus",  "+",        _NP_OFFSET + 3.0, 2, 1.0, 2.0, pygame.K_KP_PLUS),
    # Row 3
    KeyDef("np_4",     "4",        _NP_OFFSET + 0.0, 3, 1.0, 1.0, pygame.K_KP4),
    KeyDef("np_5",     "5",        _NP_OFFSET + 1.0, 3, 1.0, 1.0, pygame.K_KP5),
    KeyDef("np_6",     "6",        _NP_OFFSET + 2.0, 3, 1.0, 1.0, pygame.K_KP6),
    # Row 4
    KeyDef("np_1",     "1",        _NP_OFFSET + 0.0, 4, 1.0, 1.0, pygame.K_KP1),
    KeyDef("np_2",     "2",        _NP_OFFSET + 1.0, 4, 1.0, 1.0, pygame.K_KP2),
    KeyDef("np_3",     "3",        _NP_OFFSET + 2.0, 4, 1.0, 1.0, pygame.K_KP3),
    KeyDef("np_enter", "Enter",    _NP_OFFSET + 3.0, 4, 1.0, 2.0, pygame.K_KP_ENTER),
    # Row 5
    KeyDef("np_0",     "0",        _NP_OFFSET + 0.0, 5, 2.0, 1.0, pygame.K_KP0),
    KeyDef("np_dot",   ".",        _NP_OFFSET + 2.0, 5, 1.0, 1.0, pygame.K_KP_PERIOD),
]
